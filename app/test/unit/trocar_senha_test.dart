...
void main() {
  ...
  test('repositório grava o par novo e mata o refresh antigo', () async {
    ...
    expect(prefs.getString('token_life_and_roads'), 'token-novo');
    expect(prefs.getString('refresh_life_and_roads'), 'refresh-novo');
  });
  ...
  test('senha atual errada sobe FalhaApi e não troca o token', () async {
    ...
    final prefs = await SharedPreferences.getInstance();
    expect(prefs.getString('token_life_and_roads'), 'token-velho');
