...
class TelaDestino extends StatefulWidget {
  ...
  @override
  State<TelaDestino> createState() => _TelaDestinoState();
}
...
class _TelaDestinoState extends State<TelaDestino> {
  ...
  Future<void> _prepararOrigem() async {
    final salvo = await carregarUltimoPonto();
  ...
  String get _legenda {
    ...
    if (_destino == null) {
      return 'Toque no mapa onde você vai. Usa km de estrada, não linha reta.';
    }
    final km = _rota?.km;
    if (km == null) {
